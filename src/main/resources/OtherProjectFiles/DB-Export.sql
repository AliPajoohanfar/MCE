...
on table MCE.PERSON
  is 'پرسنل شرکت';
comment
on column MCE.PERSON.id
  is 'کلید اصلی جدول';
comment
on column MCE.PERSON.national_code
  is 'کد ملی';
comment
on column MCE.PERSON.name
  is 'نام';
comment
on column MCE.PERSON.family
  is 'نام خانوادگی';
comment
on column MCE.PERSON.father_name
  is 'نام پدر';
comment
on column MCE.PERSON.birthdate
  is 'تاریخ تولد';
comment
on column MCE.PERSON.identifire_num
  is 'شماره شناسنامه';
comment
on column MCE.PERSON.issuance_place
  is 'محل صدور شناسنامه';
comment
on column MCE.PERSON.postal_code
  is 'کد پستی
';
comment
on column MCE.PERSON.home_address
  is 'آدرس محل زندگی
';
comment
on column MCE.PERSON.mobile_number
  is 'شماره تماس همراه
';
comment
on column MCE.PERSON.phone_number
  is 'شماره تماس ثابت
';
alter table MCE.PERSON
    add constraint PERSN_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.PERSON
    add constraint PERSN_1_UK unique (NATIONAL_CODE) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.PERSON
    add constraint PERSN_2_UK unique (MOBILE_NUMBER) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
on table MCE.STATE
  is 'استان ها';
comment
on column MCE.STATE.id
  is 'کلید اصلی';
comment
on column MCE.STATE.name
  is 'نام استان';
comment
on column MCE.STATE.tel_code
  is 'کد تلفن استان';
alter table MCE.STATE
    add constraint STATE_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.STATE
    add constraint STATE_UK unique (NAME) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on column MCE.BRANCH.id
  is 'کلید اصلی';
comment
on column MCE.BRANCH.parent_id
  is 'کلید خارجی - نمایندگی بالاسری';
comment
on column MCE.BRANCH.code
  is 'کد یکتای نمایندگی';
comment
on column MCE.BRANCH.name
  is 'نام نمایندگی';
comment
on column MCE.BRANCH.state_id
  is 'کلید خارجی - استان حضور نمایندگی';
comment
on column MCE.BRANCH.person_id
  is 'کلید خارجی - مالک نمایندگی';
comment
on column MCE.BRANCH.mc_doc_print_permission
  is 'مجوز چاپ سند موتورسیکلت';
comment
on column MCE.BRANCH.branch_typ
  is 'نوع نمایندگی: ۰=فروش ۱=خدمات پس از فروش';
alter table MCE.BRANCH
    add constraint BRNCH_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.BRANCH
    add constraint BRNCH_UK unique (CODE) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.CUSTOMER
  is 'خریدار نهایی';
comment
on column MCE.CUSTOMER.id
  is 'کلید اصلی';
comment
on column MCE.CUSTOMER.national_code
  is 'کد ملی';
comment
on column MCE.CUSTOMER.name
  is 'نام';
comment
on column MCE.CUSTOMER.family
  is 'نام خانوادگی';
comment
on column MCE.CUSTOMER.father_name
  is 'نام پدر';
comment
on column MCE.CUSTOMER.birthdate
  is 'تاریخ تولد';
comment
on column MCE.CUSTOMER.identifire_num
  is 'شماره شناسنامه';
comment
on column MCE.CUSTOMER.issuance_place
  is 'محل صدور شناسنامه';
comment
on column MCE.CUSTOMER.postal_code
  is 'کد پستی
';
comment
on column MCE.CUSTOMER.home_address
  is 'آدرس محل زندگی
';
comment
on column MCE.CUSTOMER.mobile_number
  is 'شماره تماس همراه
';
comment
on column MCE.CUSTOMER.phone_number
  is 'شماره تماس ثابت
';
alter table MCE.CUSTOMER
    add constraint CUSTOMER_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.CUSTOMER
    add constraint CUSTOMER_UK unique (NATIONAL_CODE) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.ATTACHMENT
  is 'ضمائم';
comment
on column MCE.ATTACHMENT.id
  is 'کلید اصلی ';
comment
on column MCE.ATTACHMENT.attach_file_1
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_1
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_2
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_2
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_3
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_3
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_4
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_4
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_5
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_5
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_6
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_6
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_7
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_7
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_8
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_8
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_9
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_9
  is 'شرح فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_file_10
  is 'فایل ضمیمه';
comment
on column MCE.ATTACHMENT.attach_desc_10
  is 'شرح فایل ضمیمه';
alter table MCE.ATTACHMENT
    add constraint ATTACH_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.MOTORCYCLE_TYPE
  is 'انواع موتورسیکلت‌ها';
comment
on column MCE.MOTORCYCLE_TYPE.id
  is 'کیلد اصلی';
comment
on column MCE.MOTORCYCLE_TYPE.information_attach_id
  is 'کلید خارجی - لینک اطلاعات فنی';
comment
on column MCE.MOTORCYCLE_TYPE.code
  is 'کد';
comment
on column MCE.MOTORCYCLE_TYPE.name
  is 'نام';
alter table MCE.MOTORCYCLE_TYPE
    add constraint MCT_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on column MCE.STATUS.id
  is 'کلید اصلی';
comment
on column MCE.STATUS.status_flow
  is 'چهار حرفی مشخص کننده‌ی نام فرآیند برای تفکیک وضعیت‌ها از هم';
comment
on column MCE.STATUS.order_num
  is 'ترتیب';
comment
on column MCE.STATUS.code
  is 'کد یکتا در هر فرآیند';
comment
on column MCE.STATUS.desc_persian
  is 'شرح فارسی';
comment
on column MCE.STATUS.desc_english
  is 'شرح لاتین';
alter table MCE.STATUS
    add constraint STATUS_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.STATUS
    add constraint STATUS_1_UK unique (STATUS_FLOW, CODE) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.STATUS
    add constraint STATUS_2_UK unique (STATUS_FLOW, ORDER_NUM) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.ENGINE_TYPE
  is 'انواع انجین های موتورسیکلت';
comment
on column MCE.ENGINE_TYPE.id
  is 'کلید اصلی';
comment
on column MCE.ENGINE_TYPE.code
  is 'کد';
comment
on column MCE.ENGINE_TYPE.name
  is 'نام';
comment
on column MCE.ENGINE_TYPE.volume
  is 'حجم موتور به سی سی';
comment
on column MCE.ENGINE_TYPE.power
  is 'قدرت موتور به اسب بخار';
comment
on column MCE.ENGINE_TYPE.fuel
  is 'سوخت: ۰=بنزین ۱=گازئیل ۲=الکتریکی';
alter table MCE.ENGINE_TYPE
    add constraint ENGTYP_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.ENGINE_TYPE
    add constraint ENGTYP_UK unique (CODE) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.WAREHOUSE_INPUT
  is 'موتور سیکلت های ورودی به انبار';
comment
on column MCE.WAREHOUSE_INPUT.id
  is 'کلید اصلی';
comment
on column MCE.WAREHOUSE_INPUT.num
  is 'تعداد موتورهای ورودی ';
comment
on column MCE.WAREHOUSE_INPUT.engine_num_start
  is 'شروع شماره موتور';
comment
on column MCE.WAREHOUSE_INPUT.engine_num_stend
  is 'پایان شماره موتور';
comment
on column MCE.WAREHOUSE_INPUT.input_date
  is 'تاریخ ورود به انبار';
comment
on column MCE.WAREHOUSE_INPUT.control_date
  is 'تاریخ کنترل';
comment
on column MCE.WAREHOUSE_INPUT.prod_permission_date
  is 'تاریخ صدور مجوز تولید';
comment
on column MCE.WAREHOUSE_INPUT.receipt_number
  is 'شماره رسید';
comment
on column MCE.WAREHOUSE_INPUT.controller_persn_id
  is 'کلید خارجی - شخص کنترل کننده';
comment
on column MCE.WAREHOUSE_INPUT.identifiers_attach_id
  is 'کلید خارجی - لینک شناسنامه ها';
comment
on column MCE.WAREHOUSE_INPUT.receipts_attach_id
  is 'کلید خارجی - لینک رسید به انبار';
comment
on column MCE.WAREHOUSE_INPUT.reports_attach_id
  is 'کلید خارجی - لینک گزارش ورودی به انبار';
comment
on column MCE.WAREHOUSE_INPUT.prod_perm_persn_id
  is 'کلید خارجی - شخص صادر کننده مجوز تولید';
comment
on column MCE.WAREHOUSE_INPUT.bom_link
  is 'BOM لینک';
comment
on column MCE.WAREHOUSE_INPUT.year
  is 'سال';
comment
on column MCE.WAREHOUSE_INPUT.engine_type_id
  is 'کلید خارجی - نوع موتور';
comment
on column MCE.WAREHOUSE_INPUT.kootaj_num
  is 'شماره کوتاژ';
alter table MCE.WAREHOUSE_INPUT
    add constraint WHIN_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
on table MCE.COLOR
  is 'رنگ ها';
comment
on column MCE.COLOR.id
  is 'کلید اصلی';
comment
on column MCE.COLOR.code
  is 'کد رنگ';
comment
on column MCE.COLOR.persian_name
  is 'نام فارسی';
comment
on column MCE.COLOR.english_name
  is 'نام لاتین';
comment
on column MCE.COLOR.r
  is 'RGB رنگ قرمز در فرمت';
comment
on column MCE.COLOR.g
  is 'RGB رنگ سبز در فرمت';
comment
on column MCE.COLOR.b
  is 'RGB رنگ آبی در فرمت';
alter table MCE.COLOR
    add constraint COLOR_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.COLOR
    add constraint COLOR_1_UK unique (CODE) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.COLOR
    add constraint COLOR_2_UK unique (R, G, B) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.MOTORCYCLE
  is 'موتورسیکلیت های ساخته شده';
comment
on column MCE.MOTORCYCLE.id
  is 'کلید اصلی';
comment
on column MCE.MOTORCYCLE.mc_type_id
  is 'کلید خارجی - نوع موتورسیکلت';
comment
on column MCE.MOTORCYCLE.branch_id
  is 'کلید خارجی - نمایندگی فروش اصلی';
comment
on column MCE.MOTORCYCLE.customer_id
  is 'کلید خارجی - خریدار نهایی';
comment
on column MCE.MOTORCYCLE.wh_input_id
  is 'کلید خارجی - کوتاژ موتورسیکلت ورودی به انبار';
comment
on column MCE.MOTORCYCLE.engine_num
  is 'شماره یکتای موتور';
comment
on column MCE.MOTORCYCLE.chassis_num
  is 'شماره یکتای شاسی';
comment
on column MCE.MOTORCYCLE.color_id
  is 'کلید خارجی - رنگ';
comment
on column MCE.MOTORCYCLE.status_id
  is 'کلید خارجی - وضعیت موتورسیکلت درفرآیند، تولید تا تحویل مشتری';
comment
on column MCE.MOTORCYCLE.numbering_date
  is 'تاریخ شماره گذاری';
comment
on column MCE.MOTORCYCLE.exit_date
  is 'تاریخ خروج';
comment
on column MCE.MOTORCYCLE.license_plate
  is 'شماره پلاک';
comment
on column MCE.MOTORCYCLE.waybill_num
  is 'شماره بارنامه';
comment
on column MCE.MOTORCYCLE.sub_branch_id
  is 'کلید خارجی - زیر نمایندگی فروش';
comment
on column MCE.MOTORCYCLE.state_id
  is 'کلید خارجی - استان تحویل شده';
comment
on column MCE.MOTORCYCLE.customer_buy_date
  is 'تاریخ خرید توسط خریدار نهایی';
comment
on column MCE.MOTORCYCLE.mc_docs_attach_id
  is 'کلید خارجی - لینک مدارک استانداردی
';
alter table MCE.MOTORCYCLE
    add constraint MC_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.MOTORCYCLE
    add constraint MC_1_UK unique (ENGINE_NUM) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table MCE.MOTORCYCLE
    add constraint MC_2_UK unique (CHASSIS_NUM) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.AFTERSALES_SERVICE
  is 'خدمات پس از فروش';
comment
on column MCE.AFTERSALES_SERVICE.id
  is 'کلید اصلی';
comment
on column MCE.AFTERSALES_SERVICE.service_title
  is 'عنوان خدمت داده شده';
comment
on column MCE.AFTERSALES_SERVICE.service_desc
  is 'شرح خدمت داده شده';
comment
on column MCE.AFTERSALES_SERVICE.service_date
  is 'تاریخ خدمت داده شده';
comment
on column MCE.AFTERSALES_SERVICE.customer_id
  is 'کلید خارجی - مشتری مالک موتورسیکلت';
comment
on column MCE.AFTERSALES_SERVICE.motorcycle_id
  is 'کلید خارجی - موتورسیکلت سرویس گرفته';
comment
on column MCE.AFTERSALES_SERVICE.branch_id
  is 'کلید خارجی - نمایندگی سرویس دهنده';
comment
on column MCE.AFTERSALES_SERVICE.kilometer
  is 'کیلومتر وسیله در زمان مراجعه';
alter table MCE.AFTERSALES_SERVICE
    add constraint SERV_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.CUSTOMER_SUPPORT
  is 'سامانه نظرسنجی از مشتریان';
comment
on column MCE.CUSTOMER_SUPPORT.id
  is 'کلید اصلی';
comment
on column MCE.CUSTOMER_SUPPORT.customer_criticism
  is 'انتقاد مشترسی';
comment
on column MCE.CUSTOMER_SUPPORT.customer_suggestion
  is 'پیشنهاد مشتری';
comment
on column MCE.CUSTOMER_SUPPORT.customer_complaint
  is 'شکایت مشتری';
comment
on column MCE.CUSTOMER_SUPPORT.response
  is 'پاسخ به انتقادات، شکایات و پیشنهادات';
comment
on column MCE.CUSTOMER_SUPPORT.customer_pol
  is 'نظرسنجی از مشتری';
comment
on column MCE.CUSTOMER_SUPPORT.parent_id
  is 'کلید خارجی - پیگیری مجدد درخواست';
alter table MCE.CUSTOMER_SUPPORT
    add constraint CUSUP_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.FINAL_CONTROL
  is 'کنترل نهایی';
comment
on column MCE.FINAL_CONTROL.id
  is 'کلید اصلی';
comment
on column MCE.FINAL_CONTROL.person_id
  is 'کلید خارجی - فرد کنترل کننده';
comment
on column MCE.FINAL_CONTROL.status_id
  is 'کلید خارجی - وضعیت کنترل نهایی';
comment
on column MCE.FINAL_CONTROL.failure_title
  is 'عنوان خرابی';
comment
on column MCE.FINAL_CONTROL.failure_desc
  is 'شرح خرابی';
comment
on column MCE.FINAL_CONTROL.corrective_action
  is 'اقدام اصلاحی';
comment
on column MCE.FINAL_CONTROL.description
  is 'توضیحات';
alter table MCE.FINAL_CONTROL
    add constraint FC_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.PRE_DELIVERY_CONTROL
  is 'اطلاعات کنترل قبل تحویل به نمایندگی';
comment
on column MCE.PRE_DELIVERY_CONTROL.person_id
  is 'کلید خارجی - فرد کنترل کننده';
comment
on column MCE.PRE_DELIVERY_CONTROL.status_id
  is 'کلید خارجی - وضعیت کنترل قبل از تحویل';
comment
on column MCE.PRE_DELIVERY_CONTROL.failure_desc
  is 'شرح خرابی';
comment
on column MCE.PRE_DELIVERY_CONTROL.corrective_action
  is 'اقدام اصلاحی';
comment
on column MCE.PRE_DELIVERY_CONTROL.description
  is 'توضیحات';
alter table MCE.PRE_DELIVERY_CONTROL
    add constraint PDC_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
...
comment
on table MCE.QUALITY_CONTROL
  is 'گام های فرآیند کنترل کیفیت';
comment
on column MCE.QUALITY_CONTROL.id
  is 'کلید اصلی';
comment
on column MCE.QUALITY_CONTROL.qc_1_person_id
  is 'QC1 نام اپراتور';
comment
on column MCE.QUALITY_CONTROL.qc_1_status_id
  is 'QC1 وضعیت';
comment
on column MCE.QUALITY_CONTROL.qc_1_comment
  is 'QC1 توضیحات';
comment
on column MCE.QUALITY_CONTROL.qc_2_person_id
  is 'QC2 نام اپراتور';
comment
on column MCE.QUALITY_CONTROL.qc_2_status_id
  is 'QC2 وضعیت';
comment
on column MCE.QUALITY_CONTROL.qc_2_comment
  is 'QC2 توضیحات';
comment
on column MCE.QUALITY_CONTROL.qc_3_person_id
  is 'QC3 نام اپراتور';
comment
on column MCE.QUALITY_CONTROL.qc_3_status_id
  is 'QC3 وضعیت';
comment
on column MCE.QUALITY_CONTROL.qc_3_comment
  is 'QC3 توضیحات';
alter table MCE.QUALITY_CONTROL
    add constraint QC_PK primary key (ID) using index
  tablespace SYSTEM
  pctfree 10
  initrans 2
  maxtrans 255
